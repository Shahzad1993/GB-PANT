                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View Depot</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Depot</a></li>
                                            <li class="breadcrumb-item active">View Depot</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td>
																	<a href="depot1?id=<?= $record['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
