		...
		<div id="sidebar-menu">
			...
			<ul id="side-menu">
				...
				?>
					...
					<li>
						<a href="#acr_1" data-bs-toggle="collapse" aria-expanded="false" aria-controls="attendance">
							<i class="ri-calendar-line"></i>
							<span>ACR </span>
							<span class="menu-arrow"></span>
						</a>
						<div class="collapse" id="acr_1">
							<ul class="nav-second-level">
								<li>
									<a href="view-acr-list">View ACR</a>
								</li>
							</ul>
						</div>
					</li>
					...
					<?php
					$sql_get_role = "SELECT post FROM `employee` WHERE employee_code = '".$_SESSION['astro_email']."'";
					$exe_get_role = $db->select($sql_get_role);
					if ($exe_get_role->num_rows > 0) {
						$record_get_role=$exe_get_role->fetch_array();
						$sql_get_role1 = "SELECT level FROM `post` WHERE id = '".$record_get_role['post']."'";
						$exe_get_role1 = $db->select($sql_get_role1);
						if ($exe_get_role1->num_rows > 0) {
							$record_get_role1=$exe_get_role1->fetch_array();
							if($record_get_role1['level']!='8' && $record_get_role1['level']!='9' && $record_get_role1['level']!='10'){
							?>
								<li>
					...
					$conductor = 0;
					$technical = 0;
					$sql_acr = "SELECT present_post FROM `acr` WHERE reporting_authority_name = '".$_SESSION['astro_email']."'";
					$exe_acr = $db->select($sql_acr);
					if ($exe_acr->num_rows > 0) {
						while($record_acr=$exe_acr->fetch_array()){	
							...
							if ($exe_acr1->num_rows > 0) {
								...
								if($record_acr1['level']=='8' && $driver==0){
								?>
								<li>
									<a href="#driver_appraisal" data-bs-toggle="collapse" aria-expanded="false" aria-controls="driver_appraisal">
										<i class="fa fa-bus"></i>
										<span>Driver Self Appraisal</span>
										<span class="menu-arrow"></span>
									</a>
									<div class="collapse" id="driver_appraisal">
										<ul class="nav-second-level">
											<li>
												<a href="view-driver-self-conductor-appraisal-list">New Driver Self Appraisal</a>
											</li>
											<li>
												<a href="view-driver-conductor-self-appraisal">View Driver Self Appraisal</a>
											</li>
							...
							<?php
								$driver++;
								}if($record_acr1['level']=='9' && $conductor==0){
								?>
								<li>
									<a href="#conductor_appraisal" data-bs-toggle="collapse" aria-expanded="false" aria-controls="conductor_appraisal">
										<i class="fa fa-bus"></i>
										<span>Conductor</span>
										<span class="menu-arrow"></span>
									</a>
									<div class="collapse" id="conductor_appraisal">
										<ul class="nav-second-level">
											<li>
												<a href="view-conductor-self-appraisal-list">New Conductor Self Appraisal</a>
											</li>
											<li>
												<a href="view-conductor-self-appraisal">View Conductor Self Appraisal</a>
											</li>
							...
							<?php
								$conductor++;
								}if($record_acr1['level']=='10' && $technical==0){
								    
								?>
								<li>
									<a href="#technical_appraisal" data-bs-toggle="collapse" aria-expanded="false" aria-controls="technical_appraisal">
										<i class="fa fa-wrench"></i>
										<span>Technical</span>
										<span class="menu-arrow"></span>
									</a>
									<div class="collapse" id="technical_appraisal">
										<ul class="nav-second-level">
											<li>
												<a href="view-technical-self-appraisal-list">New Technical Self Appraisal</a>
											</li>
											<li>
												<a href="view-technical-self-appraisal">View Technical Self Appraisal</a>
											</li>
					...
					$sql_acr = "SELECT id FROM `acr` WHERE reviewing_authority_name = '".$_SESSION['astro_email']."'";
					$exe_acr = $db->select($sql_acr);
					if ($exe_acr->num_rows > 0) {
					?>
						<li>
					...
					$sql_acr = "SELECT id FROM `acr` WHERE accepting_authority_name = '".$_SESSION['astro_email']."'";
					$exe_acr = $db->select($sql_acr);
					if ($exe_acr->num_rows > 0) {
					?>
						<li>
					...
					<li>
						...
						<div class="collapse" id="acr">
							<ul class="nav-second-level">
								...
								<li><a href="view-self-appraisal-list1">ACR Report</a></li>
				...
				?>
					<li>
						...
						<div class="collapse" id="hq">
							<ul class="nav-second-level">
								<li>
									<a href="view-hq">View University</a>
								</li>
							</ul>
						</div>
					</li>
					<li>
						...
						<div class="collapse" id="Division">
							<ul class="nav-second-level">
								<li>
									<a href="division1">New College</a>
								</li>
								<li>
									<a href="view-division">View College</a>
								</li>
							</ul>
						</div>
					</li>
