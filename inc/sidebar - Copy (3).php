		...
		<div id="sidebar-menu">
			...
			<ul id="side-menu">
				...
				?>
					...
					<?php
					$sql_get_role = "SELECT * FROM `employee` WHERE employee_code = '".$_SESSION['astro_email']."'";
					$exe_get_role = $db->select($sql_get_role);
					if ($exe_get_role->num_rows > 0) {
						$record_get_role=$exe_get_role->fetch_array();
						$sql_get_role1 = "SELECT * FROM `post` WHERE id = '".$record_get_role['post']."'";
						$exe_get_role1 = $db->select($sql_get_role1);
						if ($exe_get_role1->num_rows > 0) {
							$record_get_role1=$exe_get_role1->fetch_array();
							if($record_get_role1['post_name_en']!='DRIVER' && $record_get_role1['post_name_en']!='CONDUCTOR'){
							?>
								<li>
						...
						<?php
							...
							<li>
								...
								<div class="collapse" id="conductor_appraisal">
									<ul class="nav-second-level">
										<li>
											<a href="view-driver-self-conductor-appraisal-list">New Conductor Self Appraisal</a>
										</li>
										<li>
											<a href="view-driver-conductor-self-appraisal">View Conductor Self Appraisal</a>
										</li>
					...
					<li>
						...
						<div class="collapse" id="acr">
							<ul class="nav-second-level">
								...
								<li><a href="view-self-appraisal-list">View ACR List</a></li>
