...
<head>
        <meta charset="utf-8" />
        <title>View University | GB Pant</title>
                                            ...
                                            <div class="table-responsive">
												<table class="table table-striped">
													...
													<tbody>
														<?php
														$i=1;
														$query="select head_quarter.*,login.core_pass from head_quarter inner join login on head_quarter.phone=login.mobile";
														$row=$db->select($query);
														...
														?>
															<tr>
																...
																<!--td><?= $record1['core_pass']; ?></td-->
																<td>
																	<form method="POST" action="hq1" target="_blank">
