...
<head>
        <meta charset="utf-8" />
        <title>University | GB Pant</title>
                                ...
                                <div class="page-title-box">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">University</a></li>
										...
										<form action="hq" method="POST">
											<div class="row form-group">
												<div class="col-md-12 mb-3">
													...
													<label style="margin-bottom: 10px;">University Location</label><br />
												
													<input id="pac-input" class="controls" value="<?= $location; ?>" type="text" placeholder="Start typing a location..." required>
