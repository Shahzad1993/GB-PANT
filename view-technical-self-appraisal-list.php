...
<head>
        <meta charset="utf-8" />
        <title>Technical Self Appraisal | UKPN</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Technical List</h4>
																		    ...
																		    while($record1=$row1->fetch_array()){
    																			if($_SESSION['astro_role']!='Admin'){
    																				...
    																				if($row2->num_rows > 0){
    																					...
    																					$create_button = '<a href="technical-self-appraisal?id='.$record1['employee_code'].'" class="btn btn-primary btn-sm">Create Self Appraisal</a>';
    																				}
    																			}else{
    																			    $create_button = '';
    																			}
