...
<head>
        <meta charset="utf-8" />
        <title>View Driver Self Appraisal | UKPN</title>
													...
													<tbody>
														...
														if($row3->num_rows > 0){
															while($record3=$row3->fetch_array()){
																$query_1="SELECT id,post_name FROM `post` WHERE id = '".$record3['present_post']."' and post_name_en='DRIVER'";
																	...
																	if($row->num_rows > 0){
																		...
																		?>
																			<tr>
																				...
																				<td>
																					<a href="view-self-appraisal-details.php?id=<?= $record['id']; ?>" class="btn btn-success btn-sm text-nowrap">View Self Appraisal Details</a>
																				</td>
																			</tr>
																		<?php
																		$i++;
