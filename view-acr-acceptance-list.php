...
<head>
        <meta charset="utf-8" />
        <title>View ACR Acceptance List | UKPN</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View ACR Acceptance List</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">ACR Acceptance</a></li>
                                            <li class="breadcrumb-item active">View ACR Acceptance List</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
															...
															while($record3=$row3->fetch_array()){
																...
																if($row0->num_rows > 0){
																	while($record0=$row0->fetch_array()){
																		$query="select * from acceptance_appraisal where employee='".$record0['employee']."'";
																		$row=$db->select($query);
																		if($row->num_rows > 0){
																		...
																		?>
																			<tr>
																				...
																				<td class=" text-wrap"><?= $record['diffrent_openion']; ?></td>
																				<td>
																					<a href="view-acr-details?id=<?= $record0['id']; ?>" class="btn btn-info btn-sm">View Acceptance Details</a>
																				</td>
																			</tr>
																		<?php
																		$i++;
