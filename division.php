                                        ...
                                        <form id="department_form" class="needs-validation" novalidate>
											<div class="row">
												<div class="col-md-4 mb-3">
													...
													<input type="text" name="division" value="<?= $division; ?>" class="form-control block_special" placeholder="College Name" required>
												</div>
												<div class="col-md-4 mb-3">
	...
	$('#department_form').on('submit', function(e){
		...
		$.ajax({
			...
			success:function(data){
				//alert(data);
				if(data=='Success'){
					$('#message').html('<p class="text-success">College Added Successfully!</p>');
					$('#department_form')[0].reset();
				}else if(data=='Success1'){
					$('#message').html('<p class="text-success">College Updated Successfully!</p>');
				}else{
